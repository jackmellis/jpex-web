...
describe('Life Cycles', function(){
  ...
  beforeEach(function(){
    ...
    Master = Jpex.extend(function(myFactory) { resultM = myFactory; });
    Master.Register.Constant('myConstant', 'master');

    ClassA = Master.extend(function(myFactory) { resultA = myFactory; });
    ClassA.Register.Constant('myConstant', 'classA');

    ClassB = Master.extend(function(myFactory){ resultB = myFactory; });
    ClassB.Register.Constant('myConstant', 'classB');

    ClassC = ClassA.extend(function(myFactory){ resultC = myFactory; });
    ClassC.Register.Constant('myConstant', 'classC');

    ClassD = ClassB.extend(function(myFactory){ resultD = myFactory; });
  ...
  describe('Application', function(){
    beforeEach(function(){
      Master.Register
        .Factory('myFactory', function(myConstant){ return {value : myConstant}; })
  ...
  describe('Class', function(){
    beforeEach(function(){
      Master.Register
        ...
        .lifecycle.class();
      Master.Register
        .Factory('mySubFactory', function(myFactory) {return myFactory;});
    });
